...
export declare const name = "ded_submit_fingerprints";
export declare const description = "Submit signed fingerprints for cryptographic notarization on the Constellation Network metagraph. Requires an API key. Each fingerprint must include an attestation with content and at least one signature proof.";
...
//# sourceMappingURL=submit-fingerprints.d.ts.map