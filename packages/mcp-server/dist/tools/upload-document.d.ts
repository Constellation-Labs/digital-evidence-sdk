...
export declare const name = "ded_upload_document";
export declare const description = "Upload documents with fingerprint submissions. Each document is base64-encoded and linked to a fingerprint by documentRef. Requires API key. Blocked for free tier.";
