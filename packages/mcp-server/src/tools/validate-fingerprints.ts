...
export const description =
  "Dry-run validation of fingerprint submissions without actually submitting them. Requires API key or x402 payment. Use this to check that fingerprints are correctly formatted before submission.";
