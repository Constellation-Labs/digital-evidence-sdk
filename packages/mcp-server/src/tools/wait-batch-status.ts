...
export const description =
  "Wait for a batch to reach a terminal status (FINALIZED_COMMITMENT or ERRORED_COMMITMENT). Holds the connection open, polling every 3 seconds until resolved or timeout. Max wait: 60 seconds.";
